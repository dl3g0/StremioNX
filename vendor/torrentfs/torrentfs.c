...
torrentfs *torrentfs_open_file(const char *source, const char *cache_path,
    ...
    return torrentfs_open_file_ex(source, cache_path, file_index, NULL, err, errlen);
}
